...
strings = {
    "ru": {
        "ro_msg": "В мут на 31 секундe."
    },
    "en": {
        "ro_msg": "You're muted for 31 seconds."
    }
}
...
def set_ro(message):
    ...
    bot.restrict_chat_member(message.chat.id, message.from_user.id, until_date=time()+31)
